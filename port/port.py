...
def delta_mount_partition_id(partition_id, user, panel=None):
    ...
    try:
        ...
        content += "\n"
        content += "Please manually mount this partition, README file will be automatically generated within %s minutes after you mount the disk" % str(panel.LISTEN["usb_port"])
        content += "\n"
        content += "\n"
